...
// Giyim kategorisi için genel öneriler - diğer kategorilerle birleştirme seçenekleri
const CLOTHING_CATEGORIES = {
  // Ana Giyim Kategorisi (ayrı kalabilir)
  'Giyim': {
    icon: '👕',
    subcategories: [
      { name: 'Günlük Giyim', icon: '👕', keywords: ['tişört', 'pantolon', 'elbise', 'gömlek', 'şort', 'etek'] },
      { name: 'Dış Giyim', icon: '🧥', keywords: ['ceket', 'mont', 'kaban', 'hırka', 'kazak', 'sweatshirt'] },
      { name: 'Ayakkabı', icon: '👟', keywords: ['ayakkabı', 'sandalet', 'bot', 'spor ayakkabı', 'topuklu'] },
      { name: 'İç Giyim', icon: '🩲', keywords: ['iç çamaşırı', 'pijama', 'gecelik', 'sutyen', 'boxer'] },
      { name: 'Spor Giyim', icon: '🏃', keywords: ['spor kıyafeti', 'egzersiz', 'fitness', 'koşu', 'yoga'] },
      { name: 'Aksesuar', icon: '👜', keywords: ['çanta', 'cüzdan', 'kemer', 'şal', 'şapka', 'eldiven'] },
      { name: 'Takı & Mücevher', icon: '💍', keywords: ['yüzük', 'kolye', 'küpe', 'bilezik', 'saat'] }
    ]
  },
  
  // Alışveriş Kategorisi ile Birleştirme (önerilen)
  'Alışveriş': {
    icon: '🛍️',
    subcategories: [
      { name: 'Giyim Alışverişi', icon: '👕', keywords: ['giyim', 'kıyafet', 'ayakkabı', 'çanta', 'aksesuar'] },
      { name: 'Elektronik', icon: '📱', keywords: ['telefon', 'bilgisayar', 'tablet', 'kulaklık', 'şarj aleti'] },
      { name: 'Ev & Yaşam', icon: '🏠', keywords: ['ev eşyası', 'dekorasyon', 'mutfak', 'banyo', 'yatak odası'] },
      { name: 'Kozmetik & Bakım', icon: '💄', keywords: ['makyaj', 'cilt bakımı', 'parfüm', 'saç bakımı', 'tırnak'] },
      { name: 'Kitap & Hobi', icon: '📚', keywords: ['kitap', 'oyun', 'hobi malzemesi', 'spor ekipmanı'] },
      { name: 'Oyuncak & Çocuk', icon: '🧸', keywords: ['oyuncak', 'bebek ürünleri', 'çocuk kıyafeti'] }
    ]
  },
  
  // Kişisel Bakım Kategorisi ile Birleştirme
  'Kişisel Bakım': {
    icon: '💅',
    subcategories: [
      { name: 'Giyim & Aksesuar', icon: '👕', keywords: ['giyim', 'kıyafet', 'ayakkabı', 'çanta', 'takı'] },
      { name: 'Kozmetik', icon: '💄', keywords: ['makyaj', 'cilt bakımı', 'parfüm', 'saç bakımı'] },
      { name: 'Sağlık & Bakım', icon: '🏥', keywords: ['vitamin', 'takviye', 'sağlık ürünü', 'bakım ürünü'] },
      { name: 'Spor & Fitness', icon: '🏃', keywords: ['spor kıyafeti', 'fitness ekipmanı', 'spor ayakkabı'] }
    ]
  },
  
  // Eğlence Kategorisi ile Birleştirme
  'Eğlence': {
    icon: '🎬',
    subcategories: [
      { name: 'Giyim & Moda', icon: '👕', keywords: ['giyim', 'moda', 'kıyafet', 'aksesuar'] },
      { name: 'Sinema & Tiyatro', icon: '🎬', keywords: ['film', 'tiyatro', 'konser', 'etkinlik'] },
      { name: 'Spor & Aktiviteler', icon: '⚽', keywords: ['spor', 'fitness', 'yüzme', 'tenis'] },
      { name: 'Hobi & İlgi Alanları', icon: '🎨', keywords: ['hobi', 'sanat', 'müzik', 'kitap'] }
    ]
  }
};

// Giyim için genel öneriler - kullanıcı tercihine göre
const CLOTHING_SUGGESTIONS = {
  // Seçenek 1: Ayrı Giyim Kategorisi (mevcut)
  separate: {
    name: 'Giyim',
    icon: '👕',
    description: 'Giyim ve aksesuar harcamaları için ayrı kategori',
    subcategories: [
      'Günlük Giyim', 'Dış Giyim', 'Ayakkabı', 'İç Giyim', 
      'Spor Giyim', 'Aksesuar', 'Takı & Mücevher'
    ]
  },
  
  // Seçenek 2: Alışveriş Kategorisi ile Birleştirme (önerilen)
  shopping: {
    name: 'Alışveriş',
    icon: '🛍️',
    description: 'Tüm alışveriş harcamaları tek kategoride',
    subcategories: [
      'Giyim Alışverişi', 'Elektronik', 'Ev & Yaşam', 
      'Kozmetik & Bakım', 'Kitap & Hobi', 'Oyuncak & Çocuk'
    ]
  },
  
  // Seçenek 3: Kişisel Bakım ile Birleştirme
  personal: {
    name: 'Kişisel Bakım',
    icon: '💅',
    description: 'Kişisel bakım ve giyim birlikte',
    subcategories: [
      'Giyim & Aksesuar', 'Kozmetik', 'Sağlık & Bakım', 'Spor & Fitness'
    ]
  },
  
  // Seçenek 4: Eğlence ile Birleştirme
  entertainment: {
    name: 'Eğlence',
    icon: '🎬',
    description: 'Eğlence ve moda harcamaları',
    subcategories: [
      'Giyim & Moda', 'Sinema & Tiyatro', 'Spor & Aktiviteler', 'Hobi & İlgi Alanları'
    ]
  }
};
